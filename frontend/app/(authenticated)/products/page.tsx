...
import { Plus, Trash2, Sparkles, Download, X, Loader2, Brain, Image, Lightbulb, ChevronDown, AlertCircle, RefreshCw, Package, Check, AlertTriangle, Activity } from 'lucide-react';
import { useProducts, useCreateProduct, useUpdateProduct, useDeleteProduct } from '@/hooks/useProducts';
import api, { getUploadUrl, type AdConcept, type AdImageResponse, type ComboAnalysis, trackerApi } from '@/lib/api';
            ...
            <div key={product.id} data-tour="product-card" className="glass p-6 sm:p-7 rounded-[2.5rem] border border-white/10 hover:border-[#7c3aed]/40 transition-colors relative group">
              ...
              <div className="flex gap-2 mt-2">
                ...
                <button
                  ...
                  disabled={trackedProductIds.has(product.id) || trackingProduct === product.id}
